...
public class LatestAgentsFragment extends Fragment {
    ...
    public static LatestAgentsFragment newInstance() {
        LatestAgentsFragment fragment = new LatestAgentsFragment();
        return fragment;
    }
